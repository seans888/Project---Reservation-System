         ...
         <div class="container">
             ...
             <div class="top-menu">
                <ul>
                     ...
                     <li><a href="index.php?r=site%2Frestaurant">RESTAURANT</a></li>
                     <li><a href="index.php?r=site%2Fconference">CONFERENCE</a></li>
                     <li><a href="index.php?r=site%2Fbooking">BOOKING</a></li>
                     <li class="active"><a href="index.php?r=site%2Fcontact">CONTACT US</a></li>
                        <div class="clearfix"></div>
                 </ul>
                 <script>
