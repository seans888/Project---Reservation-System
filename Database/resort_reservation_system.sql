...
-- -----------------------------------------------------
-- Table `resort_reservation_system`.`billing statement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resort_reservation_system`.`billing statement` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `resort_reservation_system`.`room` (
  ...
  CONSTRAINT `fk_room_billing statement1`
    ...
    REFERENCES `resort_reservation_system`.`billing statement` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `resort_reservation_system`.`walk-in`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `resort_reservation_system`.`walk-in` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `resort_reservation_system`.`reservation` (
  ...
  CONSTRAINT `fk_reservation_walk-in1`
    ...
    REFERENCES `resort_reservation_system`.`walk-in` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
